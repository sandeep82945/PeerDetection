...
from attack_adj import attack_run
import read_json
...
from utils.gpt_attack import response



# checkpoint_file = "checkpoint_paraphrasing_attack.json"
# output_file = "peer_review_outputs_paraphrasing_attack.json"
...
def main(args):
    ...
    for i in range(5,8):
        ...
        for each_dic in tqdm(read_file):
            ...
            decoded_output_without_watermark = decoded_output_without_watermark.split("START OF RESPONSE:")[-1].strip()

            decoded_output_with_watermark = decoded_output_with_watermark.split("START OF RESPONSE:")[-1].strip()
            ...
            print(f"Processed  with delta = {args.delta}: {title}")
